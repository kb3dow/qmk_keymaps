...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MY_LYR1] = LAYOUT(
        ...
        _______, _______, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT,  _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_SCROLL_LOCK, KC_PSCR, _______,
...
*/
    [MY_LYR2] = LAYOUT(                                                     
        TO(DEFLYR), TO(1), TO(2), TO(3), TO(4), TO(5), TO(6), TO(7), TO(8), TO(9), TO(10), TO(11), TO(12),   KC_BRK, KC_SCROLL_LOCK,
        _______, RGB_M_P, _______, _______,  _______,  _______, _______, _______, _______, _______, BL_TOGG, BL_DEC , BL_INC , QK_BOOTLOADER,
