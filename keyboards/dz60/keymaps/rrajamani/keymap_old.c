...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MY_LYR1] = LAYOUT(
        ...
        _______, _______, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT,  _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_SCROLL_LOCK, KC_PSCREEN, _______,
...
*/
    [MY_LYR2] = LAYOUT(                                                     
        TO(DEFLYR), M(1), M(2), M(3), M(4), M(5), M(6), M(7), M(8), M(9), M(10), M(11), M(12),   KC_BRK, KC_SCROLL_LOCK,
        _______, RGB_M_P, _______, _______,  _______,  _______, _______, _______, _______, _______, BL_TOGG, BL_DEC , BL_INC , L_RESET,
